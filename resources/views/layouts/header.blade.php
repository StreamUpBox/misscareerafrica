...
<div class="container">
	<div class="nav-header">
		...
		<span id="fh5co-logo"><a href="index.html"><img src="images/logo.png" class="img-rounded"
					style="width: 200px;height:80px;position: relative;bottom:10px"></a></span>
		<nav id="fh5co-menu-wrap" role="navigation">
			<ul class="sf-menu" id="fh5co-primary-menu">
				<li><a class="active" href="index.html">HOME</a></li>
				<li><a href="blog.html">MISS CAREER</a>
					<ul class="fh5co-sub-menu">
							<li><a href="#">Book Miss Career</a></li>
						<!-- <li><a href="#">Former Candidates</a></li> -->
						<li><a href="apply.html">Become a Candidate</a></li>
						</ul>
				</li>
